...
namespace Slingshot.Frontend {
    ...
    public class AppItem : Gtk.EventBox {
        ...
        public AppItem (int size) {
            ...
            this.can_focus = true;             // el 3 es la cantidad de texto en el nombre
            this.set_size_request (icon_size * 3, icon_size + 30); // 30 es el tamaño del espacio entre el icono y el texto
        ...
        private bool draw_background (Gtk.Widget widget, Gdk.EventExpose event) {
            ...
            if (this.has_focus) {
                ...
                linear_gradient.add_color_stop_rgba (0.2, this.prominent.R, this.prominent.G, this.prominent.B, 0.25/progress);
                ...
                if (this.current_frame > 1) {
                    var linear_gradient = new Cairo.Pattern.linear (size.x, size.y, size.x, size.y + size.height);
                    linear_gradient.add_color_stop_rgba (0.2, this.prominent.R, this.prominent.G, this.prominent.B, 0.25 - 0.25/progress);
