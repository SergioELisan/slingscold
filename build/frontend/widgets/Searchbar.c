/* Searchbar.c generated by valac 0.30.1, the Vala compiler
...
static void __lambda10_ (SlingshotFrontendSearchbar* self);
static void ___lambda10__gtk_widget_realize (GtkWidget* _sender, gpointer self);
...
static void ___lambda10__gtk_widget_realize (GtkWidget* _sender, gpointer self) {
	__lambda10_ ((SlingshotFrontendSearchbar*) self);
}
