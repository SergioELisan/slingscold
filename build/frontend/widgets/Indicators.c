/* Indicators.c generated by valac 0.26.2, the Vala compiler
...
static gboolean __lambda12_ (SlingshotFrontendIndicators* self);
...
void slingshot_frontend_indicators_append (SlingshotFrontendIndicators* self, const gchar* thelabel) {
	...
	g_signal_connect_data ((GtkWidget*) _data2_->indicator, "button-release-event", (GCallback) ___lambda11__gtk_widget_button_release_event, block2_data_ref (_data2_), (GClosureNotify) block2_data_unref, 0);
...
static gboolean ___lambda12__gsource_func (gpointer self) {
	gboolean result;
	result = __lambda12_ ((SlingshotFrontendIndicators*) self);
	return result;
}
...
void slingshot_frontend_indicators_change_focus (SlingshotFrontendIndicators* self) {
	...
	_tmp8_ = g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) ((gint) (1000 / SLINGSHOT_FRONTEND_INDICATORS_FPS)), ___lambda12__gsource_func, g_object_ref (self), g_object_unref);
...
gboolean slingshot_frontend_indicators_draw_background (SlingshotFrontendIndicators* self, GtkWidget* widget, GdkEventExpose* event) {
	...
	cairo_set_source_rgba (context, 0.0, 0.0, 0.0, 0.70);
	offset = 0.0;
	radius = 18.0;
	_tmp35_ = size;
	_tmp36_ = _tmp35_.y;
